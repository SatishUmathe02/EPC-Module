...
namespace DataAccessLayer
{
    ...
    public partial class EPC_DBEntities : DbContext
    {
        ...
        public virtual ObjectResult<usp_GTIN_GetEPC_Customer_MorellatoGroup_Result> usp_GTIN_GetEPC_Customer_MorellatoGroup(string gtin14, Nullable<long> qty, string transaction, string schema, string customerId, string customerName, string @event, Nullable<long> userId, Nullable<long> serail, string ePC, Nullable<long> rPO, Nullable<long> detailLineNo, string customPara1, string customPara2, string gS1Prefix, Nullable<int> partitionValue, Nullable<System.DateTime> ePCStartDateTime)
        {
            var gtin14Parameter = gtin14 != null ?
                new ObjectParameter("gtin14", gtin14) :
                new ObjectParameter("gtin14", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_GTIN_GetEPC_Customer_MorellatoGroup_Result>("usp_GTIN_GetEPC_Customer_MorellatoGroup", gtin14Parameter, qtyParameter, transactionParameter, schemaParameter, customerIdParameter, customerNameParameter, eventParameter, userIdParameter, serailParameter, ePCParameter, rPOParameter, detailLineNoParameter, customPara1Parameter, customPara2Parameter, gS1PrefixParameter, partitionValueParameter, ePCStartDateTimeParameter);
        }
    }
}
